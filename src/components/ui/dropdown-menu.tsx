  ...
  return (
    <MenuPrimitive.Item
      ...
      className={cn(
        ...
        "data-highlighted:bg-(--search-bg)",
        "data-highlighted:text-(--text)",

        // Make child text follow the highlighted color
        "data-highlighted:**:text-(--text)",

        // Icon color on hover
        "data-highlighted:**:[svg]:text-(--primary)",
        ...
        "data-[variant=destructive]:data-highlighted:bg-(--danger-bg)",
        "data-[variant=destructive]:data-highlighted:text-(--danger)",
        "data-[variant=destructive]:data-highlighted:**:[svg]:text-(--danger)",
...
function DropdownMenuCheckboxItem({
  ...
  return (
    <MenuPrimitive.CheckboxItem
      ...
      className={cn(
        "group/dropdown-menu-item relative flex cursor-default items-center gap-1.5 rounded-md px-1.5 py-1 text-sm outline-hidden select-none",
        "focus:bg-(--search-bg) focus:text-(--text)",
        "not-data-[variant=destructive]:focus:**:text-(--text)",
        "data-inset:pl-7",
        "data-[variant=destructive]:text-(--danger)",
        "data-[variant=destructive]:focus:bg-(--danger-bg)",
